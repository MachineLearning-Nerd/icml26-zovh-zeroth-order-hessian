...
---
<!-- trackio-cell
{"type": "code", "id": "cell_837c79ab207c", "created_at": "2026-07-22T15:20:11+00:00", "title": "Verify C1-C6", "command": ["python", "repro/src/verify.py"], "exit_code": 0, "duration_s": 9.72}
-->
````bash
...
````output
C1 estimator unification: True
C2 unbiased:                True  (baseline-indep + convergence)
C3 variance/bias:           True  (b*->F_mu, var~1/K, bias~mu^2 bounded)
C4 beats central-diff:      False  (HONEST NEGATIVE)
C6 ZO speedup:              False  (HONEST NEGATIVE)

VERIFIED 3/5 checked claims = 6 pts (+ C5 MNIST deferred, C4/C6 honest negatives)
